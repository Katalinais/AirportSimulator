// Panel de tweaks visuales. Conversión de tweaks-panel.jsx a ES module TSX.
// Exporta componentes nombrados en lugar de asignarlos a window.*.
...
export function useTweaks<T extends Record<string, unknown>>(
  ...
  const setTweak = useCallback((keyOrEdits: string | Partial<T>, val?: unknown) => {
    ...
    // Señal al host (en iframe) y a listeners en página
